'''
    Construir um programa que leia as 2 notas de um aluno e que calcule, armazene e imprima a
    édia. Se a média for maior ou igual a 7, imprimir “Aprovado”, caso contrário, realizar a leitura
