''' 
    Fazer um algoritmo para calcular a contribuição ao INSS, IR e a associação de funcionários a
...
print('Seu salário atualiza conforme as contribuições é {} : '.format(novoSalario))